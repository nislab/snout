...
class wifi_rx(gr.top_block):
    ...
    def __init__(self, channel=6):
        ...
        self.blocks_socket_pdu_0_0_0_0 = blocks.socket_pdu("UDP_CLIENT", '127.0.0.1', '52002', 10000, False)
        ...
        self.msg_connect((self.rftap_rftap_encap_0, 'out'), (self.blocks_socket_pdu_0_0_0_0, 'pdus'))
