...
class top_block(gr.top_block):
    ...
    def __init__(self, channel=908.4e6, gain=40, parameter_0=0):
        ...
        self.uhd_usrp_source_0.set_center_freq(channel + 200e3, 0)
    ...
    def set_channel(self, channel):
        self.channel = channel
        self.uhd_usrp_source_0.set_center_freq(self.channel + 200e3, 0)
